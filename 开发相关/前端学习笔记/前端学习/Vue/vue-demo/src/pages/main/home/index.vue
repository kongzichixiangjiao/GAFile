<template>
  <div class="home">
    <ga-navBar class="g-header-container">
      <template slot="left"><i class="iconfont icon-kuaijiehuifu"></i></template>
    ...
    >
      <div class="slider">
        ...
        <ga-swiper class="ga-swiper" :dataList="sliders" :direction="direction" :loop="loop" :interval="interval" :pagination="pagination" :on="on" v-else>
          <swiper-slide class="swiper-slide" v-for="(slider, index) in sliders" v-bind:key="index">
            <a class="slider-link" :href="slider.linkUrl"><img class="slider-img" :src="slider.picUrl"/></a>
          </swiper-slide>
        </ga-swiper>
      </div>
      <home-nav></home-nav>
...
import { HomeSliderAPI, HomeRecommendData } from "@/axios/api";
